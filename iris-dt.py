...
import dagshub
dagshub.init(repo_owner='pxxthik', repo_name='_MLflow-DagsHub', mlflow=True)

mlflow.set_tracking_uri("https://dagshub.com/pxxthik/_MLflow-DagsHub.mlflow")
...
with mlflow.start_run():
    ...
    mlflow.set_tag("author", "pratheek")
